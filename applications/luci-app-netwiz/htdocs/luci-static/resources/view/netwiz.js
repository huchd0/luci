...
return view.extend({
    render: function () {
        ...
        var htmlTemplate = [
            ...
            '.nw-form-area .nw-value { border: none; padding: 8px 0; display: flex; flex-direction: column; width: 100%; margin: 0; }',
            '.nw-form-area .nw-value-title { text-align: left; font-weight: 600; color: #222; font-size: 14.5px; margin: 0 0 8px 0; line-height: 1.2; display: block; }',
            '.nw-form-area .nw-value-field { width: 100%; margin: 0; padding: 0; display: block; }',
